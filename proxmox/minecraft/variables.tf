...
variable "minecraft_server_port" {
  type        = number
  description = "TCP port exposed by the Minecraft Java Edition server."
  default     = 25565
}
...
variable "vm_id" {
  type        = number
  description = "VM ID assigned to the Minecraft container. If null, the provider auto-assigns one."
  default     = null
  nullable    = true
}
